...
const APP_DATA = {
  ...
  reviews: {
    1: [
      ...
      { name: 'Оля М.',   rating: 5, text: 'Дарья — лучший мастер, всегда качественно и быстро',                        date: '8 мая'  },
    ...
    3: [
      ...
      { name: 'Женя К.',  rating: 5, text: 'Очень аккуратно, совсем не больно. Спасибо Дарье',                           date: '9 мая'  },
    ],
    4: [
      { name: 'Даша О.',  rating: 5, text: 'Форма бровей идеальная, давно так хорошо не выглядели',                      date: '16 мая' },
      { name: 'Маша П.',  rating: 5, text: 'Всегда прихожу только к Дарье, доверяю ей полностью',                        date: '11 мая' },
    ],
    5: [
